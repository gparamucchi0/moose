 ...
 */
template <bool is_ad>
class PowerLawCreepStressUpdateChowTempl : public RadialReturnCreepStressUpdateBaseTempl<is_ad>
{
public:
  static InputParameters validParams();

  PowerLawCreepStressUpdateChowTempl(const InputParameters & parameters);
...
protected:
  ...
  const Real _gas_constant;
   ...
   /// oxygen coefficient modified to go from %wt to C(O)/C(Zr) in alpah phase 
  const Real _Lambda;
  ...
  /// Exponential calculated from oxygen

  GenericReal<is_ad> _exp_ox;
...
typedef PowerLawCreepStressUpdateChowTempl<false> PowerLawCreepStressUpdateChow;
typedef PowerLawCreepStressUpdateChowTempl<true> ADPowerLawCreepStressUpdateChow;
