 ...
 */
template <bool is_ad>
class CreepChowOldValueTempl : public RadialReturnCreepStressUpdateBaseTempl<is_ad>
{
public:
  static InputParameters validParams();

  CreepChowOldValueTempl(const InputParameters & parameters);
...
protected:
  ...
  /// current and old u (reduced oxygen concentration over C(Zr)) 
...
typedef CreepChowOldValueTempl<false> CreepChowOldValue;
typedef CreepChowOldValueTempl<true> ADCreepChowOldValue;
