...
template <>
InputParameters validParams<C4ZrIC1Int>();

/**
 * Defines a boundary condition that forces the value to be a user specified
 * function at the boundary.
 */
class C4ZrIC1Int : public InitialCondition
{
public:
  static InputParameters validParams();

  C4ZrIC1Int(const InputParameters & parameters);
...
protected:
  ...
  Real _x_a_break = 580.8+1400;

  Real _x_ox_a = 590.0+1400 ;
  ...
  Real _grad_ox = (_C_ox-_C_ox_a)/(2000-_x_ox_a);
};
