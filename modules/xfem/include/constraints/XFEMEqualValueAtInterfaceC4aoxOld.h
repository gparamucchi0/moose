...
class XFEMEqualValueAtInterfaceC4aoxOld : public ElemElemConstraint
{
public:
  static InputParameters validParams();

  XFEMEqualValueAtInterfaceC4aoxOld(const InputParameters & parameters);
  virtual ~XFEMEqualValueAtInterfaceC4aoxOld();
