...
class ValueAtLSXFEMInterface : public GeneralUserObject
{
public:
  static InputParameters validParams();

  ValueAtLSXFEMInterface(const InputParameters & parameters);

  virtual ~ValueAtLSXFEMInterface() {}
...
protected:
  ...
  const LevelSetCutUserObject * _ls_cut;
