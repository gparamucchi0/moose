...
#ifndef XFEMC4VelocityZrABForOpti_H
#define XFEMC4VelocityZrABForOpti_H
...
class XFEMC4VelocityZrABForOpti;

class XFEMC4VelocityZrABForOpti : public XFEMMovingInterfaceVelocityBase
{
public:
  static InputParameters validParams();
  XFEMC4VelocityZrABForOpti(const InputParameters & parameters);
  virtual ~XFEMC4VelocityZrABForOpti() {}
