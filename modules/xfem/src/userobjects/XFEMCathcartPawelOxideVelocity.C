...
#include "XFEMCathcartPawelOxideVelocity.h"

registerMooseObject("XFEMApp", XFEMCathcartPawelOxideVelocity);

InputParameters
XFEMCathcartPawelOxideVelocity::validParams()
{
...
XFEMCathcartPawelOxideVelocity::XFEMCathcartPawelOxideVelocity(
