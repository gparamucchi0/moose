...
#include "InterfaceMeshCut2DUserObjectLS.h"
#include "XFEMMovingInterfaceVelocityBase.h"

registerMooseObject("XFEMApp", InterfaceMeshCut2DUserObjectLS);

InputParameters
InterfaceMeshCut2DUserObjectLS::validParams()
{
...
InterfaceMeshCut2DUserObjectLS::InterfaceMeshCut2DUserObjectLS(const InputParameters & parameters)
...
void
InterfaceMeshCut2DUserObjectLS::calculateNormals()
{
...
Point
InterfaceMeshCut2DUserObjectLS::nodeNormal(const unsigned int & node_id)
{
  Point normal(0.0);
...
bool
InterfaceMeshCut2DUserObjectLS::cutFragmentByGeometry(
...
Real
InterfaceMeshCut2DUserObjectLS::calculateSignedDistance(Point p) const
{
